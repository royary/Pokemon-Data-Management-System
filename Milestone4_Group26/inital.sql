...
/
BEGIN  
    EXECUTE IMMEDIATE 'DROP TABLE Gym CASCADE CONSTRAINS';
EXCEPTION WHEN OTHERS THEN NULL; END;
/
BEGIN  
    EXECUTE IMMEDIATE 'DROP TABLE RegionTypeBadge CASCADE CONSTRAINS';
EXCEPTION WHEN OTHERS THEN NULL; END;
/
BEGIN  
    EXECUTE IMMEDIATE 'DROP TABLE GymLeader CASCADE CONSTRAINS';
EXCEPTION WHEN OTHERS THEN NULL; END;
/
